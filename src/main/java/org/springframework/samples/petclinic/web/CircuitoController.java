...
public class CircuitoController {
    ...
    @InitBinder("salas")
    public void initCircuitoBinder(WebDataBinder dataBinder) {
    	dataBinder.setValidator(new CircuitoValidator());
    }
//    @InitBinder("circuito")
//    public void initCircuitoSala(WebDataBinder dataBinder) {
